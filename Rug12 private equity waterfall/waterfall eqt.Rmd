...
dmat.df=data.frame(am=1.425,pref=8,catchup=1,carry=.2)
ret=100+seq(-20,30,.1)
...
```{r}
dmat.3=data.frame(am=c(1),pref=c(8),catchup=c(1),carry=c(.3))
...
legend('topleft',col=c('red','blue','green'),legend=c('Gross Return','1.425 & 20','1 & 30'),lwd=1)
```
