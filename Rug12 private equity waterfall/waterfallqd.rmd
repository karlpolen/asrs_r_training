...
This plot shows for a given net return, what fee was paid?

```{r, fig.width=7,fit.height=5}
totfee=ans.pe$grossreturn-ans.pe$netreturn
plot(ans.pe$netreturn,totfee,type='l',col='blue',xlab='Net Return',ylab='Total Fee')
```
...
Experiment with the shiny app to enhance your understanding of the fee impacts of various private equity structures.

### Level 2

Learn how to use the __`waterfall`__ function and create an analysis that analyzes a fee structure.

### Level 3

Compare two different fee structures and create plots showing the differences.

Modify the shiny app to compare two different structures.
